...
/**
 * Mock applications for the current family — subset of system-wide data
 * that belong to this household.
 */
...
const FAMILY_APPLICATIONS: FamilyApplication[] = [
  {
    id: "app-001",
...
export default function FamilyApplicationsPage() {
  const hasApplications = FAMILY_APPLICATIONS.length > 0;
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-gray-500">
                        {getGradeLabel(app.grade)} &middot; {app.campus}
                      </p>
                    </div>
